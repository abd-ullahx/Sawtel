...
class RecurringInvoiceController extends Controller {
	...
	public function index() {
		$assets = ['datatable'];
		return view('backend.admin.invoice.recurring.list', compact('assets'));
	}
	...
	public function create(Request $request) {
		return view('backend.admin.invoice.recurring.create');
	}
	...
	public function edit(Request $request, $id) {
		$invoice = Invoice::with('items')
			...
			->where('is_recurring', 1)
			->first();
		return view('backend.admin.invoice.recurring.edit', compact('invoice', 'id'));
	}
