...
class ProductUnitController extends Controller {
    ...
    public function index() {
        ...
        return view('backend.admin.product_unit.list', compact('productunits', 'assets'));
    }
    ...
    public function create(Request $request) {
        if (! $request->ajax()) {
            ...
            return view('backend.admin.product_unit.modal.create');
        }
    }
    ...
    public function edit(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            ...
            return view('backend.admin.product_unit.modal.edit', compact('productunit', 'id'));
        }
