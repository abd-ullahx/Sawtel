...
class TaxController extends Controller {
    ...
    public function index() {
        ...
        return view('backend.admin.tax.list', compact('taxs', 'assets'));
    }
    ...
    public function create(Request $request) {
        if (!$request->ajax()) {
            ...
            return view('backend.admin.tax.modal.create');
        }
    }
    ...
    public function edit(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            ...
            return view('backend.admin.tax.modal.edit', compact('tax', 'id'));
        }
