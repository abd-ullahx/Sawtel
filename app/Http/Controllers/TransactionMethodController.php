...
class TransactionMethodController extends Controller {
    ...
    public function index() {
        ...
        return view('backend.admin.transaction_method.list', compact('transactionmethods', 'assets'));
    }
    ...
    public function create(Request $request) {
        if (!$request->ajax()) {
            return view('backend.admin.transaction_method.create');
        } else {
            return view('backend.admin.transaction_method.modal.create');
        }
    }
    ...
    public function edit(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            return view('backend.admin.transaction_method.edit', compact('transactionmethod', 'id'));
        } else {
            return view('backend.admin.transaction_method.modal.edit', compact('transactionmethod', 'id'));
        }
