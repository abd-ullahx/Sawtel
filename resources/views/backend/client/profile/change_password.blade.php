...
<div class="row">
	<div class="col-lg-6 offset-lg-3">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('client.profile.update_password') }}" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
					@csrf
					<div class="row">
						<div class="col-12">
