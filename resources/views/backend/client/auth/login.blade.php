        ...
        <div class="col-md-5">
            <div class="card card-signin p-3 my-5">
                <div class="card-body">
					...
					<h5 class="text-center py-4">{{ _lang('Login To Client Portal') }}</h4> 
					...
					<form method="POST" class="form-signin" action="{{ route('client.login') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12">
                                ...
                                @if(get_option('member_signup') == 1)
                                    <a href="{{ route('client.register') }}" class="btn btn-link btn-register">{{ _lang('Create Account') }}</a>
								@endif							
                            </div>
                        </div>
						...
						<div class="form-group row mt-3">
                            <div class="col-md-12">
								<a class="btn-link" href="{{ route('client.password.request') }}">
