...
<div id="invoice" class="{{ $type }}">
	<div class="custom-invoice">
		...
		$invoice_content = str_replace('<!--$invoice_items_header-->', view('backend.admin.invoice.template.components.invoice-items-header', compact('invoice', 'invoiceColumns'))->render(), $invoice_content);
		$invoice_content = str_replace('<!--$invoice_items-->', view('backend.admin.invoice.template.components.invoice-items', compact('invoice', 'invoiceColumns'))->render(), $invoice_content);
		$invoice_content = str_replace('<!--$invoice_summary-->', view('backend.admin.invoice.template.components.invoice-summary', compact('invoice'))->render(), $invoice_content);
		$invoice_content = str_replace('<!--$invoice_payment_history-->', view('backend.admin.invoice.template.components.invoice-payment-history', compact('invoice'))->render(), $invoice_content);
		$invoice_content = str_replace('$tax_loop', view('backend.admin.invoice.template.components.invoice-taxes', compact('invoice'))->render(), $invoice_content);
