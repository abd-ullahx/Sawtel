					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group select-customer">
								<select class="form-control customer_id_field" data-selected="{{ old('customer_id') }}" name="customer_id" data-value="id" data-display="name"
										data-href="{{ route('clients.create') }}" data-title="{{ _lang('Create New Client') }}" data-table="customers"
